...
class Groundnut extends StatefulWidget {
  const Groundnut({
    super.key,
  });

  @override
  State<StatefulWidget> createState() => GroundnutState();
}

class GroundnutState extends State<Groundnut> {
  XFile? _myImage;
  ...
  Future<void> _loadClassifier() async {
    final classifier = await Classifier.loadWith(
      labelsFileName: groundnutLabel,
      modelFileName: groundnutModel,
    );
